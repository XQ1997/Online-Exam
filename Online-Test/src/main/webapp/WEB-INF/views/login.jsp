    ...
    <div class="login-box-body radius">
        ...
        <form method="post" id="loginForm">
            <div class="form-group has-feedback">
                <input type="text" class="form-control" placeholder="学号或者工号" name="stuNumber" value="${stuNumber}" autofocus required>
            ...
            <div class="row">
                <div class="col-xs-6">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox" name="rememberMe" <c:if test="${not empty stuNumber}">  checked</c:if>> 记住我
                        </label>
                    </div>
                </div>
                <div class="col-xs-6">
